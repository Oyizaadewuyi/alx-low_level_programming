...
File holberton.h is the header file containing all the function prototypes used in this project.File 6-abs.c is a function that computes the absolute value of an integer.
